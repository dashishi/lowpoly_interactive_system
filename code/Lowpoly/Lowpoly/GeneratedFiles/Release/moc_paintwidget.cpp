...
QT_MOC_LITERAL(3, 28, 15)
    ...
    "PaintWidget\0keyPlusPressed\0\0keyMinusPressed\0"
};
...
void PaintWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->keyPlusPressed(); break;
        case 1: _t->keyMinusPressed(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PaintWidget::keyPlusPressed)) {
                *result = 0;
            }
        }
        {
            typedef void (PaintWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PaintWidget::keyMinusPressed)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void PaintWidget::keyPlusPressed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void PaintWidget::keyMinusPressed()
{
